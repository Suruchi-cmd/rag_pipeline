...
| Ages | Pass Type | Price | Duration | Includes |
|------|-----------|-------|----------|----------|
| 6+ | Premium Jump Pass | $24.90 | 90 min | Includes access to all attractions except Go Karting,Laser tag, bazooka ball, mini golf |
...
| Ages | Pass Type | Price | Duration | Includes |
|------|-----------|-------|----------|----------|
| All | Aero Socks | $3.99 | Reusable | Required for ALL jumpers on all park attractions. Bring them back for future visits. |
